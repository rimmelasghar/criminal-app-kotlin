...
class CrimeFragment: Fragment(), DatePickerFragment.Callbacks {
    ...
    private val crimeDetailViewModel: CrimeDetailViewModel by lazy { ViewModelProviders.of(this).get(CrimeDetailViewModel::class.java) }
...
//        val solvedCheckBoxListener: View.OnClickListener = View.OnClickListener { crime.isSolved = solvedCheckBox.isChecked }

//        solvedCheckBox.setOnClickListener(solvedCheckBoxListener)
